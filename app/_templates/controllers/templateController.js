...
exports.all = function(app) {
	...
	var tesla = require('../../tesla_modules/tesla.js')(app),
		uri = require('../../tesla_modules/tesla.uri.js')(app, app.req),
		teslaDB = require('../../tesla_modules/tesla.db.js')(app),
...
exports.create = function(app) {
	...
	var model = require('../models/{model}')(app),
		tesla = require('../../tesla_modules/tesla.js')(app),
		teslaDB = require('../../tesla_modules/tesla.db.js')(app),
		options = teslaDB.optionsUri( app.req.query ),
		data = app.req.query;
